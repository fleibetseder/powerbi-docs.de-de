...
* **Einschränkungen für Measures:** DAX-Funktionen und -Ausdrücke, die in Measures verwendet werden können, sind eingeschränkt. Erneut, wird AutoVervollständigen die aufgeführten einschränken, und es wird eine Fehler angezeigt, wenn eine ungültige Funktion oder ein ungültiger Ausdruck verwendet wird. Der Grund dafür ist, dass Measures auf einfache Measures beschränkt sind, die mit hoher Wahrscheinlichkeit nicht zu Leistungsproblemen führen.
