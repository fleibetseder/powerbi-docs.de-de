...
![Ausgewählter einzelner Datenpunkt](media/desktop-multi-select/multi-select_01.png)
...
![Mehrere ausgewählte Datenpunkte](media/desktop-multi-select/multi-select_02.png)
